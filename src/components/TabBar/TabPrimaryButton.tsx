...
export const TabPrimaryButtonContainer = ({
    children,
    ...props
}: ChildrenProp) => {
    ...
    return (
        <Box
            style={{ ...baseStyles.center, borderRadius, padding, marginTop }}
...
export type TabPrimaryButtonProps = {
    visible: boolean;
    rotationDegrees: number;
    handlePress: () => void;
};
export const TabPrimaryButton = ({
    visible,
    rotationDegrees,
    handlePress,
    children,
}: TabPrimaryButtonProps & ChildrenProp) => {
